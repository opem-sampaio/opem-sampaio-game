package connect.mta.matrp.gui.keyboard;
...
public final class KeyBoard implements ViewTreeObserver.OnGlobalLayoutListener, View.OnClickListener {
    ...
    public static int language = 2; //(1 - Русский / 2 - Англиский / 3 - Цифры / 4 - Символы / 5 - CMD)
    public static boolean isDialog = false;
    public static int caps = 1; //(1 - мал / 2 - биг / 3 - супер биг)
